...
- Typical flow: generate transcripts -> run `evaluation/run_batch_eval.py` or `evaluation/evaluation_agent.py` -> write outputs to `Implementation/evaluation_results/`.

Conventions:
- Code lives in `Implementation/evaluation/`.
