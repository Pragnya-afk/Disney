"""
baseline/time_auto_main.py

Non-interactive target-duration baseline story run.

Example:
    python baseline/time_auto_main.py \
...
def run_story(
    ...
    while story_state["beat_index"] < len(beats) and turn_idx < max_turns:
    ...
    print(f"[target_duration_baseline] saved: {transcript_path}")
